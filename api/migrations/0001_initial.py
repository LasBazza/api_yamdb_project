# Generated by Django 3.0.5 on 2022-01-04 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, max_length=200, unique=True, verbose_name='Название')),
                ('year', models.PositiveSmallIntegerField(null=True, validators=[api.validators.year_validator], verbose_name='Год')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(help_text='Автор', on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to=settings.AUTH_USER_MODEL, verbose_name='Автор')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(help_text='Запись', on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='api.Review', verbose_name='Запись')),
            ],
            options={
